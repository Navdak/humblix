...
class AdminPermissions
{
    public const MODULES = [
        ...
        'enquiries' => 'Enquiries',
        'client_jobs' => 'Client Job Portal',
        'commercial_agreements' => 'Commercial Agreements',
        'engineers' => 'Engineers',
    ...
    public static function normalize(string $permission): string
    {
        return match ($permission) {
            ...
            'client-jobs', 'clientjobs', 'job_conversations', 'job-conversations' => 'client_jobs',
            'commercial-agreements', 'commercialagreements', 'finance', 'job_finance', 'job-finance' => 'commercial_agreements',
