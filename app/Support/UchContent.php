...
class UchContent
{
    ...
    {
        return [
            ['title'=>'Experienced Team','text'=>'6+ years of hands-on field practice.'],
            ['title'=>'Quality Work','text'=>'Top-quality materials and disciplined installation.'],
            ['title'=>'Safety First','text'=>'Strict adherence to safety standards.'],
            ...
            ['title'=>'Global Network','text'=>'Delegates and teams across multiple regions.'],
        ];
    }
    ...
    {
        return [
            ['slug'=>'risk-assessment','title'=>'Risk Assessment','image'=>'images/generated/safety/safety-risk-assessment.jpg','description'=>'Review site conditions, hazards, access constraints and safe work steps before activity begins.','detail'=>'Risk assessment helps the team understand what could go wrong on site before installation, maintenance or supply work starts. Humelix uses this as a planning habit for practical controls, safe access and clear task sequencing.'],
            ['slug'=>'ppe-compliance','title'=>'PPE Compliance','image'=>'images/generated/safety/safety-ppe.jpg','description'=>'Use suitable personal protective equipment for the task, environment and risk level.','detail'=>'PPE expectations are matched to the work environment and task. The goal is to reduce avoidable exposure during HVAC, solar, electrical, equipment handling and home installation activities.'],
            ['slug'=>'electrical-isolation','title'=>'Electrical Isolation','image'=>'images/generated/safety/safety-electrical-isolation.jpg','description'=>'Confirm power isolation and safe conditions before electrical or powered equipment work.','detail'=>'Electrical isolation is treated as a critical control before wiring, maintenance, testing or powered equipment work. The team verifies working conditions before proceeding.'],
            ['slug'=>'working-at-height','title'=>'Working at Height','image'=>'images/generated/safety/safety-working-at-height.jpg','description'=>'Plan access, ladders, roof areas and elevated work so technicians can operate safely.','detail'=>'Working at height requires careful access planning, stable work positions and clear communication, especially for solar mounting, high-wall units, ventilation and roof-level work.'],
            ['slug'=>'lockout-tagout','title'=>'Lockout/Tagout','description'=>'Control unexpected energising of equipment during maintenance and installation work.','detail'=>'Lockout/tagout practices help prevent accidental energising while equipment, circuits or systems are being inspected, installed or serviced.'],
            ['slug'=>'toolbox-talks','title'=>'Toolbox Talks','image'=>'images/generated/safety/safety-toolbox-talks.jpg','description'=>'Brief teams before work so hazards, responsibilities and client-site rules are understood.','detail'=>'Toolbox talks create a simple communication moment before work starts. The team aligns on hazards, task sequence, PPE, access, roles and site-specific expectations.'],
            ['slug'=>'fire-prevention','title'=>'Fire Prevention','description'=>'Control ignition risks, cable routing, hot work exposure and housekeeping during projects.','detail'=>'Fire prevention focuses on awareness, housekeeping and safe handling of power, materials and tools. It is especially important around electrical work, batteries, wiring and equipment storage.'],
            ['slug'=>'incident-reporting','title'=>'Incident Reporting','description'=>'Encourage clear reporting of near misses, incidents and unsafe conditions.','detail'=>'Incident reporting supports learning and quick correction. Humelix encourages safety concerns, near misses and incidents to be reported clearly so work can improve.'],
            ['slug'=>'waste-management','title'=>'Waste Management','description'=>'Handle packaging, removed materials and work debris responsibly after service delivery.','detail'=>'Waste management keeps client sites cleaner and safer. Packaging, old components and work debris should be controlled and removed or handled responsibly after work.'],
            ['slug'=>'client-site-protection','title'=>'Client Site Protection','description'=>'Protect walls, floors, furniture, equipment and occupied areas during installation work.','detail'=>'Client site protection matters because technical work happens in real homes, offices and facilities. The team plans access, cleanliness and protection around occupied spaces.'],
            ['slug'=>'testing-and-commissioning','title'=>'Testing and Commissioning','image'=>'images/generated/safety/safety-testing-commissioning.jpg','description'=>'Check system performance, safety conditions and functional readiness before handover.','detail'=>'Testing and commissioning confirm that the completed work is ready for use. Humelix checks practical performance, safety conditions and client understanding before handover.'],
            ['slug'=>'safe-handover','title'=>'Safe Handover','image'=>'images/generated/safety/safety-safe-handover.jpg','description'=>'Explain completed work, basic safe use, maintenance needs and next support steps.','detail'=>'Safe handover closes the work responsibly. Clients should understand what was completed, how to use the system safely and what maintenance or support may be needed next.'],
        ];
    }
