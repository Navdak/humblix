...
<header class="site-header" data-site-header>
    <div class="container navbar">
        <a href="{{ route('home') }}" class="brand" aria-label="HUMELIX LIMITED home">
            <span class="brand-mark" aria-hidden="true"><img src="{{ asset('images/brand/humelix-logo-mark.png') }}" alt="" width="84" height="84" decoding="async"></span>
...
<script src="{{ asset('js/uch.js') }}?v=20260716b" defer></script>
</body>
</html>
