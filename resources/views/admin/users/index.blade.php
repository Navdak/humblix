...
<div class="admin-card">
    <div class="admin-list-intro"><strong>Access directory</strong><span>Blueprint roles, active accounts and module access foundation.</span></div>
...
<div class="admin-card" style="margin-top:14px">
    <div class="admin-list-intro"><strong>Phase 8 role matrix</strong><span>Granular role foundation; sensitive configuration remains Super Admin only.</span></div>
    <table class="admin-table"><thead><tr><th>Role</th><th>Primary modules</th></tr></thead><tbody>
        <tr><td><span class="badge">Super Admin</span></td><td>Full access to dashboard, operations, content, users, settings and SEO foundation.</td></tr>
