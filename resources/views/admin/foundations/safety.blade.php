...
<section class="admin-data-grid">
    <article class="admin-panel">
        <header class="admin-panel-head"><div><h2>Safety Centre foundation</h2><p>The public Safety Centre now carries stronger client-approved safety assurance copy and structured Read More topic pages.</p></div><span class="admin-panel-chip">Content foundation</span></header>
    ...
    <article class="admin-panel">
        ...
        <ul class="admin-checklist">
            ...
            <li><span class="status-dot is-good"></span> Public copy avoids unsafe guarantees such as zero-risk or accident-free claims.</li>
