<footer class="footer" data-animate="fade-in">
    <div class="container footer-grid">
        <div class="footer-brand">
            <a href="{{ route('home') }}" class="brand"><span class="brand-mark" aria-hidden="true"><img loading="lazy" decoding="async" width="84" height="84" src="{{ asset('images/brand/humelix-logo-mark.png') }}" alt=""></span><span class="brand-text"><strong>HUMELIX</strong><small>LIMITED</small></span></a>
